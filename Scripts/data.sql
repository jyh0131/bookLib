...
-- request_book 신청도서
desc request_book; 
-- truncate table request_book; 
insert into request_book values
(1, 'jojo123@naver.com', 'Cosmos', '칼 세이건', null, 'Ballantine Books', '2020.04.05', 0),
(2, 'ferw2@naver.com', 'Sapiens', '유발 하라리', null, 'vintage Books', '2020.04.05', 0),
(3, 'ya2354fr@yahoo.com', '먼 바다', '공지영', null, '해냄', '2020.04.05', 0),
(4, 'sdksdl@daum.net', '오늘 밤은 사라지지 말아요', '백수린', null, '마음산책', '2020.04.06', 0),
(5, 'fivestar@nate.com', '파도가 무엇을 가져올지 누가 알겠어', '박향', null, '나무옆의자', '2020.04.06', 0),
(6, 'sam223@naver.com', '마당이 있는 집', '김진영', null, '엘릭시르', '2020.04.06', 0),
(7, 'ddr23dd@naver.com', '태평천하', '채만식', null, '문학과지성사', '2020.04.08', 0),
(8, 'fdfsdasd@naver.com', '단 하나의 문장', '구병모', null, '문학동네', '2020.04.08', 0),
(9, 'ggg243r4@gmail.com', '독의 꽃', '최수철', null, '작가정신', '2020.04.08', 0),
(10, 'xodnjs1218@naver.com', '우리들의 행복한 시간', '공지영', null, '해냄', '2020.04.09', 0),
(11, 'ggg243r4@gmail.com', '우리들의 행복한 시간', '공지영', null, '해냄', '2020.04.09', 0),
(12, 'ggg243r4@gmail.com', '개발자의 글쓰기', '김철수', null, '위키북스', '2020.04.10', 0);
