...
<script>
	...
	$(function() {
		...
		if(subUrlName == "adminProfilePwCheck.do" || subUrlName == "adminProfile.do") {
...
<aside class="sideMenu">
	<ul class="sideUl">
		...
		<li><a class="sideItem item1" href="${pageContext.request.contextPath}/admin/profile/adminProfilePwCheck.do">프로필 수정</a></li>
	</ul>
</aside>