...
<aside class="sideMenu">
	<ul class="sideUl">
		...
		<li><a class="sideItem sideView" href="${pageContext.request.contextPath}/admin/statistics/LendingStatistics.do">대여 / 반납 통계<i class="fas fa-angle-right iconView"></i></a></li>
		<li><a class="sideItem" href="${pageContext.request.contextPath}/admin/statistics/BookStatistics.do">도서보유현황</a></li>
