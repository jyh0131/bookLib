...
<script>
	...
	$(function(){
		...
		// do 이름으로 구분
		if(subUrlName == "profilePwCheck.do" || subUrlName == "profile.do"){
...
<aside class="asideMenu">
	<ul>
		...
		<li><a class="asideMenuItem item1" href="${pageContext.request.contextPath}/user/member/profilePwCheck.do">내정보수정</a></li>
