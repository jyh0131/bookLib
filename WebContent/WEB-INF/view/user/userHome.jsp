...
<article class="contentWrap">
	<div class="searchBox">
		<h1>LIBRARY 도서검색</h1>
		<form action="">
			<input type="text" name="bookSch" placeholder="검색어를 입력하세요."/>
			<input type="submit" value="검색" class="bookSchbtn"/>
		</form>
	</div>
	<div class="recomWrap">
		<p class="recomTitle"><span class="orange">N</span>월 추천도서 &nbsp;&nbsp;&gt;</p>
		<p class="recomBook"><span class="purple">도서 제목</span> &nbsp;&nbsp;|&nbsp;&nbsp;</p>
	...
	<div class="bookRankWrap">
		<div class="bastBox box">
			...
			<div class="bastBookItem item">
				<div class="rankImg"><img src="../images/작은 아씨들.jpg" alt="" /></div>
		...
		<div class="newBox box">
			<h1>도서관 신착도서</h1>
			<div class="bastBookItem item">
				<div class="rankImg"><img src="../images/아직 멀었다는 말.jpg" alt="" /></div>
				<p class="rankTitle">책 이름</p>
				<p class="rankWriter">작가/역자</p>
			</div>
			<div class="bastBookItem item">
